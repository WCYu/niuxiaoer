...
public class UserInfoActivity extends BaseActivity<UpdUserInfoPresenter> implements UpdUserInfoContract.View {
    ...
    public void initData() {
        ...
        initUpData();
        initSexData();
        //yaoqingma=PrefUtils.getValue(this, Constants.YAOQINGMA);
    }
    ...
    private void initUserInfo() {
        ...
        tvBirthday.setText(App.baseInfo.getBirthday() == "" ? "点击添加" : App.baseInfo.getBirthday().replace("0:00:00",""));
        ...
        tvArea.setText(App.personnelInfo.getArea() == null ? "" : App.personnelInfo.getArea());
    ...
    private void startUpdUserInfo(String keyValue, String key, String value,String style) {
        ...
        nickName.putExtra(Constants.ACTION_TO_UPD_USER_INFO_STYLE,style);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.riv_head_photo:
                ...
                break;
            case R.id.tv_name:
                startUpdUserInfo("姓名", "nick_name", App.baseInfo.getNickName(),"name");
                break;
            case R.id.tv_gender:
                sexPicker.show();
                break;
            ...
            case R.id.tv_mailbox:
                startUpdUserInfo("邮箱", "email", App.baseInfo.getEmail(),"email");
                break;
            case R.id.tv_area:
                break;
        }
